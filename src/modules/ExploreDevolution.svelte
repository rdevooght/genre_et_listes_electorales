<script>
  ...
  const per_parliament = [
    { "group": "Chambre des représentants", "standard": 42.7, "reverse": 45.3, "without": 46 },
    { "group": "Parlement Flamand", "standard": 46.8, "reverse": 48.4, "without": 50 },
    { "group": "Parlement Wallon", "standard": 41.3, "reverse": 57.3, "without": 38.7 },
    { "group": "Parlement Bruxellois", "standard": 43.8, "reverse": 46, "without": 52.8 },
    { "group": "Parlement de la Communauté germanophone", "standard": 36, "reverse": 36, "without": 24 },
    { "group": "Parlement européen (député·es Belges)", "standard": 42.9, "reverse": 38.1, "without": 42.9 },
  ];
  const total = { "group": "Total", "standard": 43.4, "reverse": 47.3, "without": 45.9 };
...
<div class="py-4">
  ...
  <div>
      ...
      <table class="w-full mt-1 mb-3" transition:slide>
        ...
        <tr>
          <td>Sans dévolution</td>
          <td>
            <HorizontalStackedBar
              data={[
                { name: "Femmes", value: r.without, color: gender_colors.F },
                { name: "Hommes", value: 100 - r.without, color: gender_colors.M },
              ]}
            />
          </td>
        </tr>
